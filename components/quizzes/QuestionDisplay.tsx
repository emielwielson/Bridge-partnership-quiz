              ...
              >
                {positionBids.map((bid, idx) => {
                  ...
                  if (pos === 'N') {
                    ...
                    // Use same negative margin as East to create overlap
                    // East uses: cardHeight - overlap - 11 = -21px (pulls up, creates overlap)
                    // North uses: same -21px (pulls left, creates overlap, but appears further right due to row direction)
