...
interface RedoubleInterpretationInputProps {
  options: string[]
...
export default function RedoubleInterpretationInput({
  options,
  value,
  onChange,
  disabled = false,
}: RedoubleInterpretationInputProps) {
  return (
